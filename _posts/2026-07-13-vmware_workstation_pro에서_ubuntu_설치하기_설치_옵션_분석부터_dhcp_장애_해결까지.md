...
1. 이후 Windows C 드라이브가 가득 차면서 VMware 가상머신이 종료되는 문제도 발생.

이 글에서는 단순히 해결 명령만 나열하지 않고, Ubuntu 설치 옵션과 VMware 가상 하드웨어 구조를 함께 살펴보면서 각 문제의 원인을 단계적으로 좁혀간 과정을 정리한 글이다.
...
![image](/assets/image_798c5277-c3e2-4a7e-be8b-3d17bdf23447.png)
...
![image](/assets/image_b70d81cd-1e72-4886-a568-4d1b7ad97c00.png)
...
![image](/assets/image_02b6c2fe-446e-47ec-af51-58450f6b6d3b.png)
...
![image](/assets/image_862a0af9-d1ac-4e98-96b7-90c057ca9ced.png)
...
![image](/assets/image_ba0478e3-54f0-429a-afa8-dccd21a93540.png)
...
![image](/assets/image_a0f7b46f-c99a-46c4-927d-9648b720fb08.png)

그림 6. Network 설정 화면 예시. 현재 네트워크 환경은 아니다.
...
![image](/assets/image_d36338b3-c7bc-4b19-bb0a-9837174fed69.png)
...
![image](/assets/image_0ce3178a-bda6-43e5-90ae-8ebf7fe47ebf.png)
...
- VMnet1부터 그 위의 숫자들은 바로 Host Only Adapter와 연결된다. 이 말은 VMnet1을 네트워크 어댑터로 사용하면, 가상의 os환경에서 외부 이더넷으로의 통신은 불가능하지만 HOST와의 내부 통신은 가능하다는것을 의미한다.

![image](/assets/image_40ec0313-9843-4f6e-a937-357482cbb29d.png)
...
- VMnet0와는 다르게 Guest NIC과 NIC(이더넷)사이에 가상 라우터가 있다. 물리적인 NIC으로 나가기 전에 가상 라우터에서 NAT를 수행해 주소를 변환해서 나간다.
